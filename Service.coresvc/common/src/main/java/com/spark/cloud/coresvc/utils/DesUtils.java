 ...
 * <b>文件名：</b>DesUtils.java<br/>
 * <b>版本信息：</b>1.0<br/>
 * <b>日期：</b>2016年2月1日 下午4:44:48<br/>
 * 
 */
 ...
 * 
 * <b>类   名：</b>DesUtils<br/>
 * <b>类描述：</b>des加密解密工具类<br/>
 * <b>创建人：</b>rlliu<br/>
 * <b>创建时间：</b>2016年2月1日 下午4:44:48<br/>
 * <b>修改人：</b>rlliu<br/>
 * <b>修改时间：</b>2016年2月1日 下午4:44:48<br/>
 * <b>修改备注：</b><br/>
 *
 * @version 1.0<br/>
 *
...
//    {
//        String key1 = "ab";
//        String data = "http://download.cycore.cn/4/files/416d0a175357410eae0178e5320aba54.doc";
//        String str = strEnc(data, key1, null, null);
//    }
    ...
    public static String strEnc(String data, String firstKey, String secondKey, String thirdKey)
    {
        ...
        if (StringUtils.isNotBlank(thirdKey))
        {
        ...
        if (leng > 0)
        {
            if (leng < 4)
            {
                int[] bt = strToBt(data);
                int[] encByte = null;
                if (StringUtils.isNotBlank(firstKey) && StringUtils.isNotBlank(secondKey) && StringUtils.isNotBlank(thirdKey))
                {
                    int[] tempBt;
                    int x;
                    int y;
                ...
                {
                    if (StringUtils.isNotBlank(firstKey) && StringUtils.isNotBlank(secondKey))
                    {
                        int[] tempBt;
                        int x;
                        int y;
    ...
    /**
     * 
     * getKeyBytes(chang the string into the bit array)
     * 
     * @param key
    ...
    /**
     * 
     * strToBt(chang the string(it's length <= 4) into the bit array)
     * 
     * @param str
    ...
    /**
     * 
     * bt4ToHex(chang the bit(it's length = 4) into the hex)
     * 
     * @param binary
     * @return
     * @exception
    ...
    /**
     * 
     * hexToBt4(chang the hex into the bit(it's length = 4))
     * 
     * @param hex
    ...
    /**
     * 
     * byteToString(chang the bit(it's length = 64) into the string)
     * 
     * @param byteData
     * @return
     * @since 1.0
