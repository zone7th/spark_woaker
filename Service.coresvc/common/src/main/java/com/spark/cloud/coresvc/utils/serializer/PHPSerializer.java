...
/**
 * <b>类   名：</b>PHPSerializer<br/>
 * <b>类描述：</b>java实现php的序列化和反序列化<br/>
 * <b>创建人：</b>hlyu<br/>
 * <b>创建时间：</b>2015年12月24日 下午2:18:19<br/>
 * <b>修改人：</b>hlyu<br/>
 * <b>修改时间：</b>2015年12月24日 下午2:18:19<br/>
 * <b>修改备注：</b><br/>
 *
 * @version 3.1<br/>
 * 
...
public class PHPSerializer {
    ...
    private static int writeObject(ByteArrayOutputStream stream, Object obj, HashMap ht, int hv, String charset) {
        ...
        if (obj instanceof java.io.Serializable) {
            ...
            if (obj instanceof com.spark.cloud.coresvc.utils.serializer.Serializ) {
                byte[] cs = ((com.spark.cloud.coresvc.utils.serializer.Serializ) obj).serialize();
    ...
    private static UnSerializeResult unserialize(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws IllegalArgumentException, IllegalAccessException  {
        Object obj;
        switch (stream.read()) {
        case __N:
            obj = readNull(stream);
    ...
    private static UnSerializeResult readArray(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws IllegalArgumentException, IllegalAccessException  {
        stream.skip(1);
    ...
    private static UnSerializeResult readObject(ByteArrayInputStream stream, HashMap ht, int hv, HashMap rt, String charset) throws IllegalArgumentException, IllegalAccessException  {
        stream.skip(1);
        int len = Integer.parseInt(readNumber(stream));
        stream.skip(1);
        byte[] buf = new byte[len];
    ...
    private static UnSerializeResult readCustomObject(ByteArrayInputStream stream, HashMap ht, int hv, String charset) {
        ...
        if (o == null) {
            stream.skip(n);
        } else if (o instanceof com.spark.cloud.coresvc.utils.serializer.Serializ) {
            byte[] b = new byte[n];
            stream.read(b, 0, n);
            ((com.spark.cloud.coresvc.utils.serializer.Serializ) o).unserialize(b);
        } else {
            stream.skip(n);
        }
        stream.skip(1);
